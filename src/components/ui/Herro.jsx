...
export default function Herro(){
  return(
    <header id="herro" className=" h-105 flex flex-row w-[95%] md:rounded-none rounded-2xl 
    md:w-full [background:var(--gradient-herro-bg)]">
      <section className="w-full md:w-[50%] flex justify-end">
        <div className="w-[90%] md:w-[83%] h-full  flex-col justify-center pr-[15%] 
          ...
          <button className="border-none rounded-xl bg-(--content-bg) h-12 
