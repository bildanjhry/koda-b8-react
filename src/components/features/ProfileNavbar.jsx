  ...
  return (
    <div className="h-full w-full md:w-fit flex items-center ">
      {!sessionUser.id ?
        ...
        :
        <ul className="h-full w-full justify-between md:justify-start px-6 md:px-0 md:w-fit flex gap-1.5 items-center">
          <li>
            ...
            <Link to={"/cart"} className="h-10 w-10 cursor-pointer flex items-center 
              ...
              {globalCart?.length >= 1 &&
                <div className="rounded-full bg-(--info-bg) flex items-center justify-center text-light 
									text-[11px] absolute top-0 w-fit left-7 z-2 px-1.5 py-px">
                  {globalCart.length}
                </div>}
          ...
          <li className="flex items-center ml-3">
            <Link to={"/my-profiles"} className="h-10 min-w-10 justify-center 
                  cursor-pointer flex items-center gap-1">
                  <span className="bg-(--main-bg)/20 text-sm rounded-full content-cent h-8 w-8">
